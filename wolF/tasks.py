...
class Hapaseg_allelic_DP(wolf.Task):
    ...
    docker = "gcr.io/broad-getzlab-workflows/hapaseg:all_bins_v1264"
...
class Hapaseg_prepare_coverage_mcmc(wolf.Task):
    ...
    def script(self):
        ...
        if self.conf["inputs"]["region_blacklist_bed"] != "":
            script += " --region_blacklist_bed ${region_blacklist_bed}"
...
class Hapaseg_collect_coverage_mcmc(wolf.Task):
    ...
    docker = "gcr.io/broad-getzlab-workflows/hapaseg:all_bins_v1281"
