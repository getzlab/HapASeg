...
def Hatchet_Generate_Raw(sample_name = None,
    ...
    genotype_snps_task = HATCHET_genotype_snps(inputs = {"ref_fasta": localization_task["ref_fasta"],
                                                     ...
                                                     "vcf_idx": localization_task["vcf_idx"],
...
def Hatchet_Main(tumor_snp_depths=None,
                 ...
                 additional_totals_files=None # if totals are being simulated, they may be passed seperately
                ):                            # here, and will be softlinked into the directory containing the thresholds 
    ...
    return {'hatchet_seg_file': cluster_bins_task["clustered_segments"],
