...
with wolf.Workflow(workflow = GATK_Generate_Raw_Data) as w:
    w.run(run_name = 'GATK_generate_raw_realigned',
                       ...
                       bin_length = 1000,
                       exclude_sex = True,
                       panel_of_normals = 'gs://opriebe-tmp/HapASeg/benchmarking/NA12878_wgs/GATK/GATK_PoN_50samples_1kG.hdf5',
                       upload_bucket = 'gs://opriebe-tmp/HapASeg/benchmarking/NA12878_wgs/GATK/',
