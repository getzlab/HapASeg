...
def Generate_Hapaseg_Raw_Data_Workflow(
    ...
    if upload_bucket_gs_path is not None:
        ...
        upload_root_task = UploadToBucket(files = [m1_gather["cs_gather"],
                                tumor_cov_gather_task["coverage"],
                                combine_vcf_task["combined_vcf"]],
    ...
    return { "mutect_callstats": m1_gather["cs_gather"],
             "covcollect": tumor_cov_gather_task["coverage"],
             "hapaseg_hetsite_depths": hapaseg_cs_task["hapaseg_hetsite_depths"],
             "hapaseg_filtered_cs": hapaseg_cs_task["hapaseg_filtered_cs"],
             "facets_variant_depths": facets_cs_task["facets_variant_depths"],
             "facets_filtered_variants": facets_cs_task["facets_filtered_variants"],
             "ascat_variant_depths": ascat_cs_task["ascat_variant_depths"],
             "ascat_filtered_variants": ascat_cs_task["ascat_filtered_variants"],
             "eagle_phased_vcf": combine_vcf_task["combined_vcf"] 
            }
