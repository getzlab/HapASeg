...
def GATK_Sim_Workflow(sim_profile = None,
                      ...
                      raw_normal_allelecounts_path=None, # allelecounts to pass as normal file for het site detection if different from tumor
    ...
    localization_task = LocalizeToDisk(files = {
                            ...
                            "raw_normal_allelecounts": raw_normal_allelecounts_path if raw_normal_allelecounts_path is not None else "",
    ...
    generate_gatk_data_task = Generate_GATK_Sim_Data(
              inputs = {"sim_profile": sim_profile,
                        ...
                        "raw_normal_allelecounts_path":localization_task["raw_normal_allelecounts"] if raw_normal_allelecounts_path is not None else ""
                       }
                )    
    gatk_segfile = GATK_CNV_Workflow(sample_name = sample_label + f'_{np.around(purity, 2)}',
                      ...
                      normal_allele_counts = generate_gatk_data_task["normal_allele_counts"],
...
def Run_Sim_Workflows(sim_profile=None,
                      ...
                      gatk_raw_normal_allelecounts_path=None, # path to allelecounts in the normal sample to be used for het site calling
    ...
    GATK_Sim_Workflow(sim_profile=sim_profile,
                      ...
                      raw_normal_allelecounts_path = gatk_raw_normal_allelecounts_path,
