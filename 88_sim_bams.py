...
## now run everything
with wolf.Workflow(workflow = revert_and_upload, namespace = "hapaseg_sim_realign", max_concurrent_flows = 20, max_concurrent_flow_tasks = 20, scheduler_processes = 3) as w:
    # TWIST NA12878
